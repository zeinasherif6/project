...
<!-- Hero Entry Section -->
<section class="hero-entry d-flex align-items-center justify-content-center position-relative">
    <div class="hero-left"></div>
    <div class="hero-right"></div>
    <div class="hero-center text-center text-white">
        <h1 class="hero-logo mb-4">WEEKDAY</h1>
        <h3 class="mb-3">ENTER WEEKDAY</h3>
        <p class="mb-4">WHERE DO YOU WANT TO START?</p>
        <div class="hero-buttons">
            <a href="women.php" class="btn btn-outline-light btn-lg mx-2">CHOOSE WOMEN</a>
            <a href="men.php" class="btn btn-outline-light btn-lg mx-2">CHOOSE MEN</a>
        </div>
    </div>

    <!-- Optional Cookie Notice -->
    <div class="cookie-notice bg-dark text-white p-3 position-absolute bottom-0 start-0 w-100 d-flex justify-content-between align-items-center">
        <p class="mb-0 small">We use cookies to improve your experience. <a href="#" class="text-white text-decoration-underline">Read more</a></p>
        <div>
            <button class="btn btn-sm btn-light mx-1">Accept All</button>
            <button class="btn btn-sm btn-outline-light mx-1">Only Required</button>
        </div>
    </div>
</section>
